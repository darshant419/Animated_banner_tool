...
export const TemplatesPanel: React.FC = () => {
 ...
 className="p-3 bg-[#15151c] rounded-xl border border-[#2a2a35] transition-all group flex gap-3 items-center text-left"
 >
 <TemplateThumb
 ...
 <div className="bg-[#15151c] p-1.5 rounded-full shadow-sm text-red-500 opacity-0 group- transition-opacity shrink-0">
 <CheckCircle size={16} />
 </div>
 </button>
 ))}
