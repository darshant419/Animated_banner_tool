...
export const ModeSelect: React.FC<ModeSelectProps> = ({ onSelect }) => {
 ...
 className="group text-left rounded-2xl border border-[#2a2a35] bg-[#15151c] p-6 shadow-sm transition duration-300 hover:border-red-500/60 hover:bg-[#181820] hover:shadow-[0_0_35px_rgba(239,68,68,0.35)] focus:outline-none focus-visible:border-red-500/60 focus-visible:shadow-[0_0_35px_rgba(239,68,68,0.35)]"
 >
 ...
 <div className="mt-1 flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50 text-emerald-700 transition duration-300 group-hover:bg-red-500/20 group-hover:text-red-400 group-hover:translate-x-1">
 <ArrowRight size={18} />
 </div>
 </div>
 ...
 <div className="mt-1 flex h-10 w-10 items-center justify-center rounded-xl bg-red-500/10 text-red-400 transition duration-300 group-hover:bg-red-500 group-hover:text-white group-hover:translate-x-1">
 <ArrowRight size={18} />
 </div>
 </div>
 <div className="mt-6 rounded-xl border border-[#2a2a35] bg-[#1a1a21] p-4">
