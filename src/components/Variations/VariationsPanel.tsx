...
const VariationThumbnail = ({
 ...
 <div
 className={`bg-[#1a1a21] border rounded-lg p-4 flex items-center justify-center cursor-pointer transition-all group- ${active ? 'border-red-500 ring-1 ring-red-500/30' : 'border-[#232330] '}`}
 onClick={onSelect}
 >
